...
class ArthroGraph:
    ...
    def plot_file(self, filename="", wait=.1, interpolate=10, rotate=False, flip=False, bounds=None):
        ...
        if not bounds:
            return "File plotting is only possible when ArthroGraph.bounds is set."
    ...
    def plot_lines(self, lines=[], wait=.1, interpolate=10, rotate=False, flip=False, bounds=None):
        ...
        if not bounds:
            return "Line plotting is only possible when ArthroGraph.bounds is set."
    ...
    def test_pattern(self, bounds=None, wait=1, interpolate=10, repeat=1):
        ...
        if not bounds:
            return "Plotting a test pattern is only possible when ArthroGraph.bounds is set."
    ...
    def box(self, bounds=None, wait=.15, interpolate=10, repeat=1, reverse=False):
        ...
        if not bounds:
            return "Box drawing is only possible when ArthroGraph.bounds is set."
    ...
    def centre(self):
        ...
        if not bounds:
            return "Moving to the centre is only possible when ArthroGraph.bounds is set."
...
# this is an example ArthroGraph definition
